...
@master
	<li>
		<a class="app-menu__item @if( rn() == 'donation.index' ) active @endif" href="{{route("donation.index")}}">
			<i class="ml-2 material-icons">money</i>
			<span class="app-menu__label"> @lang('DONATIONS') </span>
		</a>
	</li>
	<li>
